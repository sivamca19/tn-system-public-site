...
const products = [
  ...
  {
    name: 'Finshields',
    tagline: 'Your Financial Guardian',
    ...
    features: [
      ...
      'Family Vault & Legacy Sharing',
      'Secure Bank & Investment Records',
      'End-to-End Encryption',
      'Multi-User Support'
    ],
    icon: ShieldCheck,
    gradient: 'from-emerald-500 to-emerald-600',
    link: '/products/finshields',
    badge: 'Finance',
    color: 'emerald'
  },
  {
    ...
    features: [
      ...
      'Poll the Crowd',
      'Set Your Mood',
      'Favorite & Track Trends'
    ],
    icon: Clock,
    gradient: 'from-indigo-500 to-purple-600',
    link: '/products/waitify',
    badge: 'Social',
    color: 'indigo'
  }
];
